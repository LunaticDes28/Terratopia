...
/*public class ModImprovementData
{
    public ImprovementData.Type? type;
    public int[]? customPopulation = null;

    public ModImprovementData() //ctor needed because uhh it is needed
    {
        type = null;
    }
}*/
...
public class ModData
{
    ...
    /// </summary>
    /// <typeparam name="T1">TerratopiaData list type</typeparam>
    /// <typeparam name="T2">id type</typeparam>
    /// <typeparam name="T3">field value type</typeparam>
    /// <param name="list">Terratopiadata list</param>
    ...
    /// <summary>
    /// Finds an entry based on "type" for a list of a specific TerratopiaData
    /// </summary>
    /// <typeparam name="T1">Type of TerratopiaData</typeparam>
    /// <typeparam name="T2">Type of TerratopiaData.type</typeparam>
    /// <param name="list">List of TerratopiaDatas to search in</param>
    /// <param name="type">The TerratopiaData.type to search with</param>
    ...
    /// </summary>
    /// <typeparam name="T1">The listed TerratopiaData type</typeparam>
    /// <typeparam name="T2">TerratopiaData.type, of which we are looking at</typeparam>
